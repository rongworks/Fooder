...
class ProductItemsControllerTest < ActionController::TestCase
  ...
  test "should create product_item" do
    assert_difference('ProductItem.count') do
      post :create, product_item: { code: @product_item.code, last_check_in: @product_item.last_check_in, last_checkout: @product_item.last_checkout, quantity: @product_item.quantity }
    end
  ...
  test "should update product_item" do
    patch :update, id: @product_item, product_item: { code: @product_item.code, last_check_in: @product_item.last_check_in, last_checkout: @product_item.last_checkout, quantity: @product_item.quantity }
    assert_redirected_to product_item_path(assigns(:product_item))
  end
